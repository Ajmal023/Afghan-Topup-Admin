...
import { dialogsRouter } from "./dialogs.js";
import { carouselsRouter } from "./carousels.js";
...
router.use("/home", dialogsRouter); 
// router.use("/home", carouselsRouter);
...
adminRouter.use("/dialogs", dialogsRouter);
