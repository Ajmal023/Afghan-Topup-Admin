...
echo "mysql -u $DB_USER -p$DB_PASS $NEW_DB -e \"SELECT id, amount, status, is_checked, createdAt FROM transactions WHERE id BETWEEN $START_ID AND $END_ID ORDER BY id DESC LIMIT 5;\""
